...
import damicore.tree_simplification as nj

from damicore.tree import to_graph
from damicore._utils import frequency, normalize_list
from damicore.partition import clusters_to_membership as c2m
...
def tree_clustering(g, leaf_ids, community_detection_name='fast',
  ...
  weights = [1.0/abs(length) for length in g.es['length']]
